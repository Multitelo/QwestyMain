  ...
  return (
    <div className="px-5 mt-5 md:mt-3">
      ...
      <div className="flex gap-3 my-5">
        ...
        <input
          type="text"
          className="border-x-0 w-full placeholder:text-xl placeholder:text-[#636387] md:w-[70%] border-b-[1px] focus:outline-none bg-transparent border-gray-400  px-2 py-1 mr-2"
